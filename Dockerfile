...
ARG NEXT_PUBLIC_ENV
ARG ROBOTS_TXT
ARG NEXT_PUBLIC_ACCESS_USER
ARG NEXT_COOKIE_DOMAIN
...
ENV NEXT_PUBLIC_ACCESS_USER=$NEXT_PUBLIC_ACCESS_USER
ENV NEXT_COOKIE_DOMAIN=$NEXT_COOKIE_DOMAIN
...
RUN echo "NEXT_PUBLIC_ACCESS_USER ===> $NEXT_PUBLIC_ACCESS_USER"
RUN echo "NEXT_COOKIE_DOMAIN --> $NEXT_COOKIE_DOMAIN"
